...
var token = 'patR01ybcZJtK4It9.e6b1a59c10d4e5b1300484e0ca59e04d2503efaf3162301af982a42fed79ceac';
airtable_umd_default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable_umd_default().base('appgsmWYHeYhUu8Gf');
  ...
  return new Promise(function (resolve, reject) {
    ...
    base('teasers').select({
      ...
      result.forEach(function (record) {
        content.push(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
          id: record.id,
          title: record.fields['Title'],
          description: record.fields['Description']
        }, "description", record.fields['Description']), "tags", record.fields['Tags']), "images", record.fields['Images']), "url", record.fields['URL']));
      });
      resolve(content);
    });
  });
